...
\othercommitteemembers
{
  ...
  Professor 3 \\
  Professor 4 \\
  Professor 5, Outside Member
}

\degreeyear{Advancement Date Here}
...
\acknowledgments
{
  ...
  Matt for making this
  
  Acknowledge grants and other funding assistance. 
...
\executivesummary
{
 Text of executive summary goes here.
}
